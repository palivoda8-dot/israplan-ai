            ...
            <div className="mb-6 border-2 border-gray-200 rounded-xl overflow-hidden h-[500px] shadow-inner relative z-0">
                ...
                >
                    <LayersControl position="topright">
                        ...
                        <LayersControl.BaseLayer name="תצ״א (לוויין)">
                            <TileLayer
                        ...
                        <LayersControl.BaseLayer name="תצ״א עם רחובות">
                            <LayerGroup>
                                <TileLayer
                                    ...
                                    <div className="flex flex-col gap-2 mt-3">
                                        ...
                                        <div className="flex gap-2 mt-1">
                                            {loc.name.includes("אילת") ? (
                                                ...
                                                <a 
                                                    href={`https://www.yad2.co.il/realestate/rent?searchText=${encodeURIComponent(loc.name)}`}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
